...
Original SHIFT artwork and documentation are licensed under the **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (CC BY-NC-SA 4.0)**.
...
- `assets/shift-badge.svg`, raster derivatives, SHIFT documentation, and the icon embedded in userscript metadata
